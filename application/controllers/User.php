...
class User extends CI_Controller {
    ...
    public function instructor_revenue($param1 = "") {
        ...
        $payment_history = $this->crud_model->get_instructor_revenue();
    ...
    public function instructor($page) {
        ...
        $page_data['instructor'] = $this->ajax_model->get_instructor_by_user_id($this->session->user_id);

        $page_data['page_name'] = $page;
        $page_data['page_title'] = 'Instructor Terms';
        $this->load->view('backend/index', $page_data);
    }
}
