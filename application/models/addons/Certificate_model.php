	...
	*/
	...
	public function create_certificate($user_id = "", $course_id = "", $certificate_identifier = "") {
		...
		for ($i=0; $i < $splited_certificate_template_part; $i++) {
			...
			$config_certificate['wm_font_path'] = realpath('./system/fonts/Palatino.ttf');
		...
		$config_instructor_name_plebeya['wm_font_path'] = realpath('./system/fonts/Plebeya.otf');
		...
		$config_instructor_name_palatino['wm_font_path'] = realpath('./system/fonts/Palatino.ttf');
		...
		$config_date_plebeya['wm_font_path'] = realpath('./system/fonts/Plebeya.otf');
		...
		$config_date_palatino['wm_font_path'] = realpath('./system/fonts/Palatino.ttf');
		...
		$config_certificate_number_palatino['wm_font_path'] = realpath('./system/fonts/Palatino.ttf');
		...
		$config_certificate_url_palatino['wm_font_path'] = realpath('./system/fonts/Palatino.ttf');
