...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item">
			<a href="<?php echo site_url('user/instructor/instructor_bank'); ?>" class="side-nav-link <?=($page_name=='instructor_bank' ? 'active' : '')?>">
				<i class="fa fa-university" aria-hidden="true"></i>
				<span>Instructor Bank Account</span>
			</a>
		</li>
		<li class="side-nav-item">
			<a href="<?php echo site_url('user/instructor/instructor_term'); ?>" class="side-nav-link <?=($page_name=='instructor_term' ? 'active' : '')?>">
